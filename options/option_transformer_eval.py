...
def get_args_parser():
    ...
    ## resume
    parser.add_argument("--resume-pth", type=str, default='output/vq/2024-06-03-20-22-07_retrain/net_last.pth', help='resume vq pth')
    parser.add_argument("--resume-trans", type=str, default='output/t2m/2024-06-04-09-29-20_trans_name_b128/net_last.pth', help='resume gpt pth')
    
    
    ## output directory 
    parser.add_argument('--out-dir', type=str, default='output', help='output directory')
    parser.add_argument('--exp-name', type=str, default='eval_name', help='name of the experiment, will create a file inside out-dir')
